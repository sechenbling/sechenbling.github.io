const getInitStatus = function () {
    ...
    const a = {KEY_PV: "pv", KEY_PV_SRC: "pv_src", KEY_CREATION: "pv_created_date"},
    ...
    return {
        keysCount() {
            ...
            if (localStorage.length !== PvStorage.keysCount()) localStorage.clear(); else for (let e = 0; e < localStorage.length; e++) switch (localStorage.key(e)) {
                case a.KEY_PV:
                case a.KEY_PV_SRC:
                case a.KEY_CREATION:
                    break;
...
function countUp(e, t, a) {
    e < t && ((a = new CountUp(a, e, t)).error ? console.error(a.error) : a.start())
}

function countPV(t, a) {
    let r = 0;
    if (void 0 !== a) for (let e = 0; e < a.length; ++e) if (a[parseInt(e, 10)][0] === t) {
...
function tacklePV(e, t, a, r) {
    t = 0 === (t = countPV(t, e)) ? 1 : t;
    r ? (e = parseInt(a.text().replace(/,/g, ""), 10)) < t && countUp(e, t, a.attr("id")) : a.text((new Intl.NumberFormat).format(t))
}
